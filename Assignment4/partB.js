...
function restart(){
    ...
    document.getElementById("guess").innerHTML="Your have 10 guesses";
...
function check(){
    var out ="";
        ...
        if(move>0){
            ...
            document.getElementById("guess").innerHTML = "Remaining guesses: " + move;
            document.getElementById("result").innerHTML = out;
        }
        else{
            alert("You Lost. The correct number is "+r );
            restart();
        }
}
